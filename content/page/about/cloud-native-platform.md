...
- 方向：云原生运维开发、多云K8s集群管理、平台工程、AI Infra

## 个人简介

近7年平台研发与运维经验，其中5年+聚焦云原生与基础设施平台建设。在华为数据底座项目中，主导 **300+ 集群**统一纳管与监控体系建设，覆盖 EKS 等多云环境，推动资源利用率提升 30%+、成本降低 20%+。在可利邦主导 **从0到1搭建 Kubernetes 基础平台**（镜像仓库、NFS、监控告警、日志平台、APISIX 网关、OpenVPN 网络），具备生产级集群规划、部署、升级与维护经验。擅长以开发方式推进运维平台化，覆盖可观测、资源治理、交付自动化与中间件稳定性建设。

## 职业定位

- 目标岗位：云原生运维开发工程师、平台运维开发工程师、SRE / 平台可靠性工程师。
- 能力画像：Kubernetes 平台化、可观测体系建设、资源治理与容量管理、运维自动化。
- 延展方向：在云原生平台能力基础上，向 AI Infra / MLOps 平台工程延伸。

## 关键成果

- 多云集群治理：建设统一纳管能力，覆盖 300+ 集群、最大 1000+ 节点及多类资源对象。
- 可观测与稳定性：构建 Prometheus / Grafana / AlertManager / ECK 体系，故障发现时效缩短到 5 分钟以内。
- 资源效率与成本：通过资源采集、利用率分析与容量治理，推动资源利用率提升 30%+、成本降低 20%+。
- 平台化交付：完成监控、日志、网关、镜像与部署链路从 0 到 1 建设并持续演进。
- AI Infra 协同：在 GPU 集群与 Ray / KubeRay / Volcano 调度实践中沉淀跨域平台工程经验。
...
- **K8s 认证方向**：已通过 CKAD，持续推进 CKA、CKS 认证准备，系统强化集群管理、安全加固与云原生安全能力，持续学习 K8s 网络隔离、Admission Controller 与 OPA/Gatekeeper 策略实践。
